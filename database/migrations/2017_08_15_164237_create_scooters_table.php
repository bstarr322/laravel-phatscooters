...
class CreateScootersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Scooters", 'scooters', 'date', 'fa-trophy', [
            ["name", "Name", "Name", false, "John Doe", 0, 255, true],
            ["email", "Email", "Email", false, "example@email.com", 0, 256, true],
            ["model", "Model", "Dropdown", false, "", 0, 256, true, ["Phatty Original","Phatty Sport"]],
            ["order_number", "Order Number", "String", true, "", 0, 256, true],
